...
/*#__PURE__*/
function (_BaseModel) {
  _inherits(ArticleModel, _BaseModel);

  function ArticleModel(authorId, title, article) {
    var _this;

    _classCallCheck(this, ArticleModel);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ArticleModel).call(this));
